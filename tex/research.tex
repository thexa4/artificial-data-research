...
\begin{center}
	...
	\parbox{0.7\linewidth}{ \includegraphics[width=0.8\linewidth]{results-001.png} } \\
	\parbox{0.7\linewidth}{ \small $r = 0.007$ } \\
	\parbox{0.7\linewidth}{ \includegraphics[width=0.8\linewidth]{results-007.png} } \\
	\parbox{0.7\linewidth}{ \small $r = 0.100$ } \\
	\parbox{0.7\linewidth}{ \includegraphics[width=0.8\linewidth]{results-100.png} } \\
	\parbox{0.7\linewidth}{ \small $r = 0.700$ } \\
	\parbox{0.7\linewidth}{ \includegraphics[width=0.8\linewidth]{results-700.png} } \\
\end{center}
